...
{	
	 ...
	 */
	public static function get($data = null, $count = false) 
	{
		$obj = new self();
		...
		if($count)
			return (int)$obj->db->fetch_array($query)[0];
	...
	public static function check_duplicate($name, $link) 
	{
		$obj = new self();

		$sql  = " select * from contents ";
		$sql .= " where name='".$name."' or link='".$link."'";
		$sql .= " limit 1";
		$query = $obj->db->query($sql);
